            ...
            <nav className="bg-white shadow-md sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="hidden md:flex justify-center space-x-8 py-2 border-t border-gray-200 text-sm text-gray-700">
                        ...
                        <Link to="/mobiles" className="hover:text-indigo-600">Laptops</Link>
                        <Link to="/mobiles" className="hover:text-indigo-600">TVs</Link>
                        <Link to="/mobiles" className="hover:text-indigo-600">Appliances</Link>
                        <Link to="/mobiles" className="hover:text-indigo-600">Accessories</Link>
                    </div>
                </div>
            </nav>
        </div>
