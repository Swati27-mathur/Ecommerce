                ...
                <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2 text-sm">
                            <li><Link to="/mobiles" className="hover:text-indigo-600">Mobiles</Link></li>
                            <li><a href="/mobiles" className="hover:text-indigo-600">Laptops</a></li>
                            <li><a href="/mobiles" className="hover:text-indigo-600">TVs</a></li>
                            <li><a href="/mobiles" className="hover:text-indigo-600">Accessories</a></li>
                        </ul>
                    </div>
                    {/* Support Links */}
                    <div>
                        ...
                        <ul className="mt-4 space-y-2 text-sm">
                            ...
                            <li><a href="/ordertracking" className="hover:text-indigo-600">Order Tracking</a></li>
                        </ul>
                    </div>
                ...
                <div className="bg-gray-200 py-4">
                    <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-600">
                        ...
                        <div className="flex space-x-4 mt-2 md:mt-0">
                            ...
                            <Link to="/termsandcondition" className="hover:text-indigo-600">Terms of Service</Link>
                        </div>
                    </div>
                </div>
            </footer>
